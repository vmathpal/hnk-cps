...
function EditRole() {
  ...
  const fetchUser = () => {
    axios
      .get(process.env.REACT_APP_API_KEY + "singleRole/" + id)
      .then((res) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (data) => {
      ...
      setIsLoading(true);
      await axios
        .post(process.env.REACT_APP_API_KEY + "edit-role/" + id, data, {
          headers: {
                ...
                <div className="custom-control col-md-12 ">
                  ...
                  <div className="department">
                    ...
                    <div className="form-check">
                      <input
                        className={
                          initialValues.department === "other"
                            ? "form-check-input checked-class"
                            : "form-check-input"
                        }
                        type="radio"
                        ...
                        id="flexRadioDefault2"
                        onChange={formik.handleChange}
                        defaultChecked={initialValues.department === "other"}
                        onClick={(e) => radioHandler(2)}
                      />
                      <label
                        className="form-check-label"
